        ...
        @if(Session::has('cart'))
            <div class="py-4 w-full flex flex-col md:flex-row  justify-around items-center">
                ...
                <div class='flex flex-row items-center justify-center p-5'>
                    ...
                    @guest
                             <a href="{{ route('contactForm')}}"  class='w-auto bg-primary-600 hover:bg-primary-700 rounded-lg shadow-xl font-medium text-white px-4 py-2 mx-2'>Naruči</a>
                    ...
                    @auth
                        <form method="POST" action="{{ route('narudzba') }}">
                            @csrf
                                ...
                                <button type="submit" class='w-auto bg-primary-600 hover:bg-primary-700 rounded-lg shadow-xl font-medium text-white px-4 py-2 mx-2'>Naruči</button>
